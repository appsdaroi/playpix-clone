...
const IOSNotification = ({ data, setNotification, value }) => {
  ...
  return (
    <motion.div
      ...
      animate={{ y: "0%", x: "-50%" }}
      exit={{ y: "-120%", x: "-50%" }}
      className={`${inter.className} notification fixed flex gap-3 text-white top-3 rounded-3xl items-center left-1/2 z-[999] bg-neutral-500/80 backdrop-blur w-[95%] h-[4.5rem] p-4`}
    >
