...
const AndroidNotification = ({ data, setNotification, value }) => {
  ...
  return (
    <motion.div
      ...
      animate={{ y: "0%", x: "-50%" }}
      exit={{ y: "-120%", x: "-50%" }}
      className={`${inter.className} notification fixed flex gap-3 text-black top-3 rounded-xl items-center left-1/2 z-[999] bg-white w-[95%] h-22 p-4 shadow-xl shadow-black/10`}
    >
      <div className="grid">
